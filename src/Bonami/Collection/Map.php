...
class Map implements Countable, IteratorAggregate
{
     ...
     * @template B
     *
     * @phpstan-param array<A, B> $array
     *
     * @phpstan-return static<A, B>
     */
     ...
     * Complexity: o(n)
     *
     * @phpstan-return array<string, V>
     */
    public function toAssociativeArray(): array
    {
        /** @phpstan-var array<string, V> */
        $assoc = array_combine(
     ...
     * @template B
     *
     * @phpstan-param Map<A, B>|iterable<array{0: A, 1: B}> $iterable
     *
     * @phpstan-return static<A, B>
     */
