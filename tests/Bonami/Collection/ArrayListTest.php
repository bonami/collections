...
class ArrayListTest extends TestCase {
	...
	public function testLift(): void {
		$lifted = ArrayList::lift(function ($a, $b) { return $a . $b; });
	...
	public function testTraverse(): void {
		$fillAForOdd = function (int $i): ArrayList { return $i % 2 === 0 ? ArrayList::of($i) : ArrayList::fromEmpty(); };
	...
	public function testFlatMap(): void {
		$this->assertEquals(
			ArrayList::of([0], [1]),
			ArrayList::of(0, 1)->flatMap(static function ($i) { return [[$i]]; })
		);
	}
	...
	public function testFlatten_itShouldFailWhenItemCannotBeFlattened(): void {
	...
	public function testUniqueMap(): void {
		...
		$this->assertEquals(
			ArrayList::of(2, 6, 10),
			$a->uniqueMap(static function ($item): int { return $item * 2; })
		);
	}
	...
	public function testUniqueByObjects(): void {
		...
		$this->assertEquals($expected, $objects->uniqueBy(static function (stdClass $object) { return $object->a; }));
	}
	...
	public function testFilter(): void {
		$this->assertEquals(
			ArrayList::of(1, 3),
			ArrayList::of(1, 2, 3)->filter(static function ($i): bool { return $i % 2 !== 0; })
		);
	}
	...
	public function testFind(): void {
		$this->assertEquals(
			Option::some(2),
			ArrayList::of(1, 2)->find(static function ($value): bool { return $value === 2; })
		);
	}

	public function testFind_notMatch(): void {
		$this->assertEquals(
			Option::none(),
			ArrayList::of(1, 2)->find(static function ($value): bool { return $value === 3; })
		);
	}

	public function testFind_empty(): void {
		$this->assertEquals(
			Option::none(),
	...
	public function testFindKey(): void {
		$this->assertEquals(
			Option::some(1),
			ArrayList::of(1, 2)->findKey(static function ($value) { return $value === 2; })
		);
	}

	public function testFindKey_notMatch(): void {
		$this->assertEquals(
			Option::none(),
			ArrayList::of(1, 2)->findKey(static function ($value) { return $value === 3; })
		);
	}

	public function testFindKey_empty(): void {
		$this->assertEquals(
			Option::none(),
	...
	public function testNotExists_empty(): void {
	...
	public function testIndex(): void {
		$this->assertEquals(
			...
			ArrayList::of(1, 2)->index(static function ($value) { return $value * 10; })
		);
	}
	...
	public function testHead_empty(): void {
	...
	public function testTake_fewerElements(): void {
	...
	public function testGroupBy(): void {
		...
		$grouped = ArrayList::of($o1, $o2, $o3)->groupBy(static function ($o) { return $o->b; });
