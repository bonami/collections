...
class TrySafeTest extends TestCase {
	...
	public function testCreateFromCallable(): void {
		...
		$throwCallable = function () { throw new Exception(); };
	...
	public function testMap(): void {
		...
		$mapperThatThrows = function () { throw new Exception(); };
	...
	public function testReduce(): void {
		$reducer = function (int $reduction, int $val): int { return $reduction + $val; };
		$initialReduction = 4;
	...
	public function testLaws(): void {
		...
		$throws = function () { throw $this->createHashableException(); };
